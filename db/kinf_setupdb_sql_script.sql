...
CREATE TABLE hylleblomst.fakultaeten(FakultaetenID integer PRIMARY KEY NOT NULL, Name varchar(255));
...
CREATE TABLE hylleblomst.person(
	...
	FakultaetenID integer NOT NULL, 
	FundortID integer NOT NULL, 
...
CREATE TABLE hylleblomst.ort_norm(OrtNormID integer PRIMARY KEY NOT NULL, OrtNorm varchar(255), OrtAbweichungNormID integer NOT NULL, CONSTRAINT OrtNorm_OrtAbweichungNorm_FK FOREIGN KEY (OrtAbweichungNormID) REFERENCES HYLLEBLOMST.ORT_ABWEICHUNG_NORM(OrtAbweichungNormID) ON DELETE RESTRICT ON UPDATE RESTRICT);
