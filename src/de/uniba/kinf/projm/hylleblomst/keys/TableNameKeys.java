...
public class TableNameKeys {
	...
	public static final String ORT_ABWEICHUNG_NORM = SCHEMA_NAME + ".ort_abweichung_norm";
	...
	public static final String WIRTSCHAFTSLAGE_NORM = SCHEMA_NAME + ".wirtschaftslage_norm";
	public static final String WIRTSCHAFTSLAGE_TRAD = SCHEMA_NAME + ".wirtschaftslage_trad";
	public static final String WIRTSCHAFTSLAGE_INFO = SCHEMA_NAME + ".wirtschaftslage_info";
	...
	public static String[] getNormTableNames() {
		String[] normTables = { ANREDE_NORM, FACH_NORM, FAKULTAETEN, FUNDORTE, VORNAME_NORM, NAME_NORM, QUELLEN,
				SEMINAR_NORM, TITEL_NORM, WIRTSCHAFTSLAGE_NORM };
		return normTables;
	}

	public static String[] getAllTableNames() {
		String[] allTables = { ANREDE_NORM, ANREDE_TRAD, QUELLEN, FUNDORTE, FAKULTAETEN, TITEL_NORM, TITEL_TRAD, PERSON,
				FACH_NORM, FACH_TRAD, FACH_INFO, NAME_NORM, NAME_TRAD, NAME_INFO, VORNAME_NORM, VORNAME_TRAD,
				VORNAME_INFO, ORT_ABWEICHUNG_NORM, ORT_NORM, ORT_TRAD, ORT_INFO, SEMINAR_NORM, SEMINAR_TRAD,
				SEMINAR_INFO, WIRTSCHAFTSLAGE_NORM, WIRTSCHAFTSLAGE_TRAD, WIRTSCHAFTSLAGE_INFO, ZUSAETZE,
				ZUSAETZE_INFO };
		return allTables;
	}
}
